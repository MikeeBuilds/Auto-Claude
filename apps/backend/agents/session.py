...
def is_tool_concurrency_error(error: Exception) -> bool:
    ...
    return (
        ...
        ("tool" in error_str and "concurrency" in error_str or
         "too many tools" in error_str or
         "concurrent tool" in error_str)
    )
...
async def run_agent_session(
    ...
    try:
        ...
        if is_concurrency:
            ...
            print(f"   Claude API limits concurrent tool use in a single request")
